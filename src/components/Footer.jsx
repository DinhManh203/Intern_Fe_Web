      ...
      <div className='flex flex-col sm:grid sm:grid-cols-[2fr_1fr_1fr] gap-14 my-10 mt-40 text-sm'>
        ...
        <div>
            ...
            <p className='w-full md:w-2/3 text-gray-600'>
                Lorem ipsum dolor sit amet consectetur, adipisicing elit. Exercitationem pariatur doloremque similique recusandae quasi doloribus a nemo consequuntur vel. Facere non ex dolorem sint accusamus totam officia hic doloribus vero.
            </p>
        </div>
